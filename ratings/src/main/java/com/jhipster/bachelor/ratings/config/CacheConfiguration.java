package com.jhipster.bachelor.ratings.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ratings");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ratings");
        ...
        config.getMapConfigs().put("com.jhipster.bachelor.ratings.domain.*", initializeDomainMapConfig(jHipsterProperties));
