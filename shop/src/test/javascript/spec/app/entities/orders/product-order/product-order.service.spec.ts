...
import { ProductOrderService } from 'app/entities/orders/product-order/product-order.service';
import { IProductOrder, ProductOrder } from 'app/shared/model/orders/product-order.model';
...
describe('Service Tests', () => {
    describe('ProductOrder Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ProductOrder(0, 0, 0, 0);
        });
