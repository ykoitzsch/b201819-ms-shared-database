...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("orders");
        ...
        config.getMapConfigs().put("com.jhipster.bachelor.orders.domain.*", initializeDomainMapConfig(jHipsterProperties));
